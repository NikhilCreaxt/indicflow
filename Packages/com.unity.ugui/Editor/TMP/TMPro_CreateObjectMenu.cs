...
namespace TMPro.EditorUtilities
{
    public static class TMPro_CreateObjectMenu
    {
        ...
        /// <summary>
        /// Create a HarfBuzzTextMeshProUGUI object that works with the CanvasRenderer
        /// </summary>
        /// <param name="menuCommand"></param>
        [MenuItem("GameObject/UI (Canvas)/Text - HarfBuzzTextMeshPro", false, 2002)]
        static void CreateHarfBuzzTextMeshProGuiObjectPerform(MenuCommand menuCommand)
        {
            GameObject go = ObjectFactory.CreateGameObject("Text (HarfBuzz TMP)", typeof(HarfBuzzTextMeshProUGUI));

            // Override text color and font size
            HarfBuzzTextMeshProUGUI textComponent = go.GetComponent<HarfBuzzTextMeshProUGUI>();

            if (textComponent.m_isWaitingOnResourceLoad == false)
            {
                // Get reference to potential Presets for <HarfBuzzTextMeshProUGUI> component
                Preset[] presets = Preset.GetDefaultPresetsForObject(textComponent);
